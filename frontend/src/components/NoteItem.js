...
export default function NoteItem(props) {
    ...
    return (
        <div className="max-w-sm p-6 bg-white rounded-lg dark:bg-gray-200  w-full text-left shadow shadow-violet-400 ">
            ...
            {/* <!-- Main modal --> */}
            <div id="deleteModal" tabIndex="-1" aria-hidden="true" className="hidden  overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full  h-modal md:h-full">
                <div className="relative p-4 w-full max-w-md h-full md:h-auto">
                    {/* <!-- Modal content --> */}
                    <div className="relative p-4 text-center bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
                        <button type="button" className="text-gray-400 absolute top-2.5 right-2.5 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-600 dark:hover:text-white" data-modal-toggle="deleteModal" onClick={toggleDeleteModal}>
                        ...
                        <div className="flex justify-center items-center space-x-4">
                            ...
                            <button type="submit" className="py-2 px-3 text-sm font-medium text-center text-white bg-red-600 rounded-lg hover:bg-red-700 focus:ring-4 focus:outline-none focus:ring-red-300 dark:bg-red-500 dark:hover:bg-red-600 dark:focus:ring-red-900" onClick={() =>    deleteNotes(props.notes.id)
                            }>
                                Yes, I'm sure
                            </button>
                        </div>
            ...
            {showUpdateForm === props.notes.id && <NoteUptateForm notes={props.notes} />}
