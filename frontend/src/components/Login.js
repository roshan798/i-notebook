...
const FormErrors = (props) => {
    return (
        <>
            <div className="flex p-4 mb-4 text-sm text-blue-800 rounded-lg bg-blue-50 dark:bg-gray-800 dark:text-blue-500" role="alert">
...
export default function Login() {
    ...
    const { showAlert, setShowAlert } = useContext(NoteContext);
    ...
    return (
        <>
            {showAlert && <Notification {...notificationProps} />}
                    ...
                    <form className="space-y-2" action="/" method="POST" onSubmit={onSubmitHandler}>
                        <div>
                            ...
                            <div className="mt-2">
                                ...
                                {(error.emailError) && <span className="flex items-center  font-medium mt-1 tracking-wide text-red-500 text-xs ml-1">
                                    {error.emailError}
                                </span>}
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div className="mt-2">
                                ...
                                {(error.passwordError) && <span className="flex items-center  font-medium mt-1 tracking-wide text-red-500 text-xs ml-1">
                                    {error.passwordError}
                                </span>}
                            </div>
                        </div>
