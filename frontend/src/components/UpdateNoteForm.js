    ...
    return (
        <div className="fixed z-10 bg-white p-6 rounded-md shadow-lg max-w-md top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 ">
            ...
            <form className='mt-10 sm:mx-auto sm:w-full px-4 sm:px-0 sm:max-w-sm flex flex-col gap-y-2' onSubmit={submitHandler}>
                <label htmlFor="edit-title" className='block text-sm font-medium leading-6 text-gray-400 text-left'>Title <sup className='text-red-500'>*</sup>
                    <input type="text" id='edit-title' name='title' className='block text-lg w-full px-2 rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-400 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6' value={notes.title} onChange={onChangeHandler} required />
                </label>
                <label htmlFor="edit-content" className="block text-sm font-medium leading-6 text-gray-400 text-left ">Content <sup className='text-red-500'>*</sup>
                    <input type="text" id='edit-content' name='content' className="block text-lg w-full px-2 rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-400 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" value={notes.content} onChange={onChangeHandler} required />
                </label>
